    ...
    const podborki: ISelect[] = [
        ...
        },
        {
            ...
            movie: [{
                ...
                shortDescription: 'спецоперации по поиску оружия талибов...',
                imageUrl: 'https://avatars.mds.yandex.net/get-kinopoisk-post-img/2423210/7fa2da18c626025b4d6ea388030a682d/960',
                movieCardUrl: 'https://kinotochka.ru/movie/106',
                index: 6,
                year: 2023,
                genres: ['Хоррор', 'Драмма', 'Вымысел', 'Ясновидинее'],
        ...
        },
        {
            ...
            movie: [{
                ...
                shortDescription: 'спецоперации по поиску оружия талибов...',
                imageUrl: 'https://xage.ru/media/uploads/2008/2/posteryi-luchshih-filmov-poluchivshih-oskar/posteryi-luchshih-filmov-poluchivshih-oskar_1.jpg',
                movieCardUrl: 'https://kinotochka.ru/movie/106',
                index: 6,
                year: 2023,
                genres: ['Хоррор', 'Драмма', 'Вымысел', 'Ясновидинее'],
        ...
        },
        {
            id: 6,
            title: 'Смородина',
            description: 'Употребление ягод смородины опосредованно влияет на улучшение микроциркуляции в области органов',
            movie: [{
                id: '106',
                title: 'Вечное сияние чистого разума',
                rating: {
                ...
                shortDescription: 'спецоперации по поиску оружия талибов...',
                imageUrl: 'https://i.pinimg.com/236x/4f/8d/e1/4f8de1ec6a7a0b90350b3796aaa6762d.jpg',
                movieCardUrl: 'https://kinotochka.ru/movie/106',
                index: 6,
                year: 2023,
                genres: ['Хоррор', 'Драмма', 'Вымысел', 'Ясновидинее'],
