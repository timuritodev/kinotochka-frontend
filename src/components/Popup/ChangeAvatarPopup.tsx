   ...
   const changeValue = (event: React.ChangeEvent<HTMLInputElement>) => {
	...
	return (
		<Popup isOpened={isOpened} setIsOpened={setIsOpened}>
			...
			<h4 className="popup__title popup__title_type_avatar">Изменить аватарку</h4>
            <form>
                <div className='popup__avatar-list'>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='comedy' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={comedy}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='cartoon' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={cartoon}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='horror' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={horror}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='fantastic' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={fantastic}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='thriller' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={thrilleer}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='anime' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={anime}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='melodrama' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={melodrama}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='drama' onChange={changeValue}></input>
                    <img className='popup__avatar-item' src={drama}></img> 
                </label>
                <label className='popup__label'>
                    <input type='radio' className='popup__avatar-input' name='avatar' value='family' onChange={changeValue}></input>
			...
			<button className="popup__close-avatar" onClick={() => setIsOpened(false)}>
				Отменить
			</button>
            </div>
		</Popup>
