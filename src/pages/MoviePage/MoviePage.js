	...
	return (
		<section className="moviepage">
			<div className="movie-block">
				<img className="movie-block__img" alt="" src={movie.picture} />
				<div className="movie-block__text">
					<h2 className="movie-block__text_title">{movie.title}</h2>{' '}
					{/* тут пропс на название фильма */}
					<p className="movie-block__text_year">{movie.year}</p>{' '}
					{/* тут пропс на год фильма */}
					<p className="movie-block__text_subtitle">{movie.description}</p>{' '}
					{/* тут пропс на описание фильма */}
				</div>
